...
sudo zypper in gamemoded libgamemode0 libgamemode0-32bit libgamemodeauto0 libgamemodeauto0-32bit gamemode
...
sudo zypper in libappindicator libdbusmenu-gtk3-devel
